...
const EditAbout = () => {
  ...
  // Fetch banner data
  useEffect(() => {
    fetch(`https://servers.virtualshopbd.com/editabouts/${id}`)
      .then((res) => res.json())
  ...
  const handleUpdate = async (e) => {
    ...
    if (imageFile) {
      try {
        ...
        updatedBanner.image = imageUrl; // Update image with the new image URL
      } catch (error) {
        Swal.fire({
          icon: "error",
    ...
    fetch(`https://servers.virtualshopbd.com/aboutdataupdate/${id}`, {
      method: "PUT",
